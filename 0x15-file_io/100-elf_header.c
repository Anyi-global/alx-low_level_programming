 ...
 * @e_ident: pointer to an array containing the Elf members
 *
 * Return: void
 */
void print_class(unsigned char *e_ident)
 ...
 * @e_ident: a pinter to an array containing the ELF version
 */
void print_version(unsigned char *e_ident)
{
...
/**
 * main - a program that displays the information contined in the ELF header
